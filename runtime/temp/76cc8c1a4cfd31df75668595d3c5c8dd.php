...
<body>
    ...
    <div class="container">
        ...
        <div class="page-title sp" style="background-image: url(/static/index/images/page-title.jpg)">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="about-content">
                            <h3>USA’s most trusted 3D and graphic designing studio, a very passionate team inside.
                            </h3>
                    ...
                    <div class="col-md-6">
                        <div class="about-img">
                            <img src="/static/index/images/about.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tab-pane fade show active" id="mission" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                                    exercitation ullamco laboris nisi ut aliquip. You would need to research online, for
                                    newspapers that are in your area.</p>
                            </div>
                        </div>
                    </div>
