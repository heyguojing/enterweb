	 ...
	 <div class="header">
        <div class="header_menu">
            ...
            <div class="header_right">
                <ul class="userinfo">
                <li class="username"><a href="javascript:void(0)" class="toUserInfo">我是XX<i class="fa fa-angle-down fa-1x"></i></a><span>|</span> 
                	<ul>
               ...
               <div class="order_right" >
                   ...
                   <div class="order_right_show" id="register_0" style="display:block">
                       <div class="order_right_content" >
                           ...
                           <p>{:date('Y-m-d H:i:s',$order.add_time)} | XXX | 订单号： {$order.order_no} |在线支付 <span>订单金额：<b> {$order.pay_money}</b> 元 </span></p>

                           {volist name="$order.order_product_list" id="vo"}
                           <div class="order_right_shop">
                              <img src="{$vo.product.img}" style="height: 30px;">
                              <p>{$vo.product.title} <br>{$vo.product.price}元 X{$vo.count}</p>
                   ...
                   {/volist}
                   <?php }else{?>
                   <div class="order_right_show" id="register_1">
                       <p>当前没有待支付订单。</p>
                   </div>
                   <?php }?>
