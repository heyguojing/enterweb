    ...
    <div class="content-bottom">
        <div class="content-bottom1">
            ...
            <div class="content-bottom1_shop">
                <div class="content-bottom1_shop1" style="margin-right:10px;"></div>
                <div class="content-bottom2_shop">
						{volist name="phone_list" id="phone"}
                        <div class="content-bottom_1" style="margin-right:10px;">
                            <img class="bottomImg" src="{$phone.img}" alt="">
                            <h3 class="bottomTitle"><a href="/index.php/index/index/detail?prono={$phone.pro_no}">{$phone.title}</a> </h3>
                            <p class="bottomDesc">{$phone.keywords}</p>
                            <p class="bottomPrice">
                                <span style="color:#ff6709">{$phone.price} 元</span>
                                <?php if($phone['orignal_price']>0){?>
                                <del><?php echo $phone['orignal_price'];?> 元</del>
                                <?php }?>
                            </p>
                        </div>
                        {/volist}
...
<!--                 <div class="content-bottom2_shop1"> -->
                    <div class="content-bottom2_1" style="margin-right:10px;"></div>
                    <div class="content-bottom_2" style="margin-right:10px;">
...
<!--                 <div class="content-bottom2_shop2"> -->
                    <div class="content-bottom2_2" style="margin-right:10px;"></div>
                    <div class="content-bottom_2" style="margin-right:10px;">
...
<!--                 </div> -->
            ...
            <div class="content-bottom2_shop">
<!--                 <div class="content-bottom2_shop1"> -->
                    <div class="content-bottom3_1" style="margin-right:10px;"></div>
                    <div class="content-bottom_2" style="margin-right:10px;">
                        <span class="bottomFlagGreen">享八折</span>
...
<!--                 </div> -->
                    <div class="content-bottom3_6" style="margin-right:10px;"></div>
                    <div class="content-bottom_2" style="margin-right:10px;">
