...
<html>
<head>
    <title>{$product.title}—小米商城</title>
    <meta charset="utf-8">
	 ...
	 <div class="header">
        <div class="header_menu">
            ...
            <div class="header_right">
                <ul>
                <li><a href="/index.php/index/account/login">登录</a><span>|</span></li>
    ...
    <div class="shop_detail">
    	...
    	<div class="shop_detail_pic">
			<div class="layui-carousel" id="test1" lay-filter="test1">
			  <div carousel-item="">
                {volist name="$product_imgs" id="vo"}
			    <div><img src="{$vo.url}" style="width: 100%;"></div>
                {/volist}
			  </div>
			</div> 
    	</div>
    	<div class="shop_detail_menu">
    		...
    		<div class="detail_map">
                ...
                <?php if($address){?>
    			<span><?php echo (isset($province['name'])?$province['name']:'').'  '.(isset($city['name'])?$city['name']:'').'  '.$address['address']?>  <a href=""style="color:#FF6A00;" >  &nbsp;修改 </a> </span>
                <?php }else{?>
                <span>北京  &nbsp;北京市   &nbsp;东城区   &nbsp;永定门外街道  <a href=""style="color:#FF6A00;" >  &nbsp;修改 </a> </span>
                <?php }?>
                <br>
    		...
    		<div class="shop_detail_zj">
    		    <div>
      	            <p>{$product.title}</p><span id="phonePrice">{$product.price}元</span>
      	            <div class="clear"></div>
      	        </div>
      	        <p id="totalPrice" style="color:#FF6A00;font-size: 25px;margin-left: 30px;">总计&nbsp;：&nbsp;{$product.price}元</p>
      	    </div>
      	    <div class="shop_detail_cart" onclick="add_carts()">加入购物车</div>
...
function add_carts(){
    ...
    $.post('/index.php/index/member/add_carts',{'pro_no':pro_no},function(res){
        if(res.code>0){
            layer.msg(res.msg,{'icon':2});
        }else{
            layer.msg(res.msg,{'icon':1});
            setTimeout(function(){window.location.href="/index.php/index/member/carts";},1000);
        }
    },'json');
}
</script>
